		            	...
		            	<div class="col-md-6">
		            		...
		            		<form class="form-inline" id="productForm">
		            			<div class="form-group">
			            			...
			            			<button type="submit" class="btn btn-primary btn-lg btn-flat rounded">Request</button>
			            		</div>
		            		</form>
		            	</div>
		            	<div class="col-md-6">
		            		<h1 class="page-header"><?php echo $product['prodname']; ?></h1>
		            		<h3><b><?php echo number_format($product['counter']); ?></b></h3>
		            		<h5><b>Category:</b> <a href="category.php?category=<?php echo $product['cat_slug']; ?>"><?php echo $product['catname']; ?></a></h5>
